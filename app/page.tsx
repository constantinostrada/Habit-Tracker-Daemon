export default function Home() {
  return (
    <main className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="mx-auto flex min-h-screen w-full max-w-3xl flex-col px-6 py-16 sm:px-10 sm:py-24 lg:py-32">
        ...
        <section
          ...
          className="mt-16 flex flex-1 items-center justify-center sm:mt-24"
        >
